      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none prose-lg">
          <div className="bg-card border border-border rounded-3xl p-12 space-y-12 shadow-lg">
            ...
            <div className="border-b border-border/50 pb-8">
              ...
              <div className="bg-muted/50 rounded-2xl p-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-base font-semibold text-foreground">Responsable del tratamiento: NEXO – Soluciones Digitales & Consultoría</p>
                  </div>
                </div>
            ...
            <div className="border-b border-border/50 pb-8">
              <h3 className="text-xl font-bold text-foreground mb-4 flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-[#00c2ff] text-sm font-bold">4</span>
                Finalidades del Tratamiento
              </h3>

              <div className="space-y-8">
                <div>
                  <h4 className="text-lg font-semibold text-foreground mb-4">4.1 Atención comercial</h4>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-muted-foreground">
                    {[
                ...
                <div>
                  <h4 className="text-lg font-semibold text-foreground mb-4">4.2 Prestación de servicios</h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-foreground mb-4">4.3 Comunicaciones comerciales</h4>
                  <p className="text-muted-foreground leading-relaxed mb-4 text-base">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-foreground mb-4">4.4 Mejoramiento de nuestros servicios</h4>
                  <p className="text-muted-foreground leading-relaxed mb-4 text-base">
            ...
            <div className="border-b border-border/50 pb-8">
              ...
              <div className="bg-muted/50 rounded-2xl p-6 mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-base font-semibold text-foreground">nexosolutions5@gmail.com</p>
                  </div>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed mb-6 text-base">
